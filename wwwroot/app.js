...
const TRANSLATIONS = {
  ar: {
    ...
    'quick-chips':        ['📚 ما هي الكتب المتاحة؟', '🔍 كيف أبحث؟', '📄 كيف أحمّل PDF؟', '👤 كيف أسجّل؟', '💰 هل الخدمة مجانية؟', '📞 كيف أتواصل معكم؟'],
  ...
  en: {
    ...
    'quick-chips':        ['📚 What books are available?', '🔍 How to search?', '📄 How to download PDF?', '👤 How to register?', '💰 Is it free?', '📞 How to contact you?'],
